...
export default function Home() {
  ...
  return (
    <>
      ...
      <nav className='w-full  shadow-md relative '>
        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            ...
            <Link href="https://in.linkedin.com/company/gdscvimeet/"><div className="cursor-pointer linkedin">
            ...
            <Link href="https://www.instagram.com/gdscvimeet/"><div className="cursor-pointer insta">
            ...
            <Link href="https://twitter.com/gdscvimeet/"><div className="cursor-pointer twitter">
      ...
      <div className="  w-full p-2 text-center bg-gray-900 text-gray-300">Devloped By <a href="" className="text-orange-400">bandya2003</a> </div>
    </>
  )
}
